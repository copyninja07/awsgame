    ...
    <>
      <div style={{ backgroundColor: "#1E90FF", color: "white" }}>
        <p style={{ padding: "30px" }}>
          You can only withdraw cash after your bet amount recharge the top-up
          amount. For example, if you recharge 200rs, you can withdraw money
          only after your accumulated bet amountreaches 200rs. Our withdrawal
          time is 10:00-22:00, other time will not provide withdrawal services.{" "}
        </p>
      </div>
      <div
        style={{
      ...
      >
        <div>
          <h6 style={{ padding: "20px" }}>
            Available balance: 0.00 <BiRupee />
          </h6>
        </div>
        ...
        >
          ...
          <div style={{ marginLeft: "20px" }}>
            <Button variant="light" onClick={() => setModalShow1(true)}>
              Read Rule
            </Button>
          </div>
      ...
      <ModalReadRule show={modalShow1} onHide={() => setModalShow1(false)} />
